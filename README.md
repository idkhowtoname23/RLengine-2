...
- Volumetric Collision Box: The bounding box for physics was expanded across all three axes (1600 x 1600 x 1600 units), creating an enclosed 3D cube instead of flat boundaries.
- Three-Dimensional Near-Clipping Projection: Added a Z2 > 10 check that clips particles located behind or too close to the camera lens, preventing visual artifacts.
